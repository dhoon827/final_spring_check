...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "DsC7r_3sFasoD01p6bMf";
	private final static String CLIENT_SECRET = "luF5nivuEg";

	private final static String REDIRECT_URI = "http://localhost:8090/memberboard/naverloginok";
